...
// alert("c");
     ...
     var CommentedPostText = CommentedPost.textContent;
...
submitComment(newComment);
                            ...
                            postViewer.text(posts[i].body);
                            postViewer.addClass("post-viewer");
                            postViewer.attr("id","" + i + "" ); 

//as of now commentContainer has no id and is affecting the proper placementy
